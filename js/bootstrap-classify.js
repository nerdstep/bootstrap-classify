...
(function ($, window, document, undefined) {
  ...
  $.fn.classify.templates = {
    ...
    modal: _.template('<div class="modal" tabindex="-1" role="dialog" id="<%= id %>"><div class="modal-dialog"><div class="modal-content"><% if (title) { %><div class="modal-header"><button type="button" class="close"  data-dismiss="modal"><span aria-hidden="true"><i class="icon-cross-16"></i></span><span class="sr-only">Close</span></button><h4 class="modal-title"><%= title %></h4></div><% } %><div class="modal-body"><div class="bs-classify"></div></div></div></div></div>'),
